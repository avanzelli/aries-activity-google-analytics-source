 ...
 */
export default async function(credentials, callback) {
  var clientSecret = credentials.client.client_secret;
  var clientId = credentials.client.client_id;
  var redirectUrl = credentials.client.redirect_uris[0];
  var auth = new googleAuth();
  var oauth2Client = new auth.OAuth2(clientId, clientSecret, redirectUrl);
  var creds = {"access_token": credentials.oauth2.access_token,
